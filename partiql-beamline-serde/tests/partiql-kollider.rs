...
pub fn verify_correct_encoding() {
    ...
    let ddl_expected = r#""a" UNION<INT8,DECIMAL(5, 4),DOUBLE,VARCHAR>,"ar1" ARRAY<DECIMAL(2, 1)>,"ar2" ARRAY<VARCHAR>,"ar3" ARRAY<DECIMAL(5, 4)>,"ar4" ARRAY<TINYINT>,"ar5" ARRAY<UNION<INT8,DECIMAL(5, 4),DOUBLE,VARCHAR>>,"d" DECIMAL(2, 0),"f" DOUBLE,"i8" TINYINT,"tick" INT8,"w" DECIMAL(5, 4)"#;

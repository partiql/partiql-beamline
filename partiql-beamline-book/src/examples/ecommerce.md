...
rand_processes::{
    ...
    customers: static_data::{
        $data: {
            customer_id: UUID,
            email: Format::{ pattern: "user{UniformU32::{ low: 1000, high: 9999 }}@email.com" },
            name: LoremIpsumTitle,
    ...
    customers: $n_customers::[
        {
            ...
            'sessions_{$@n}': rand_process::{
                ...
                $data: {
                    ...
                    cart_abandonment_reason: Uniform::{ 
                        choices: ["high_shipping", "price_check", "distracted", "payment_issue", null],
                    }
                }
            },
            ...
            'orders_{$@n}': rand_process::{
                $arrival: HomogeneousPoisson::{ interarrival: days::UniformU8::{ low: 7, high: 45 } },
                $data: {
                    order_id: UUID,
                    customer_id: $customer_id,
...
rand_processes::{
    ...
    orders: rand_process::{
        $arrival: HomogeneousPoisson::{ interarrival: minutes::UniformU8::{ low: 3, high: 45 } },
        $data: {
            order_id: UUID,
            customer_id: Uniform::{ choices: $customer_ids },
            order_date: Instant,
    ...
    reviews: rand_process::{
        $arrival: HomogeneousPoisson::{ interarrival: hours::UniformU8::{ low: 6, high: 72 } },
        $data: {
            review_id: UUID,
            product_id: Uniform::{ choices: $product_ids },
            customer_id: Uniform::{ choices: $customer_ids },
    ...
    support_tickets: rand_process::{
        $arrival: HomogeneousPoisson::{ interarrival: hours::UniformU16::{ low: 4, high: 96 } },
        $data: {
            ticket_id: UUID,
            customer_id: Uniform::{ choices: $customer_ids },
...
rand_processes::{
    ...
    holiday_shopping: rand_process::{
        ...
        $arrival: HomogeneousPoisson::{ interarrival: seconds::UniformU16::{ low: 30, high: 300 } },
        $data: {
            order_id: UUID,
            customer_id: UUID,
            timestamp: Instant,
    ...
    regular_shopping: rand_process::{
        $arrival: HomogeneousPoisson::{ interarrival: hours::UniformU8::{ low: 1, high: 12 } },
        $data: {
            order_id: UUID,
            customer_id: UUID,
            timestamp: Instant,
...
rand_processes::{
    ...
    web_analytics: rand_process::{
        $arrival: HomogeneousPoisson::{ interarrival: seconds::UniformU8::{ low: 1, high: 30 } },
        $data: {
            event_id: UUID,
            session_id: UUID,

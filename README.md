...
| `--exclude-pathstep-internal-project` | Enable generation of projection-type internal path steps (e.g., the `.foo` in `variable.foo`)                                             |                 N                  |            N             |                  Y                  |             Y             |             |
...
| `--exclude-pathstep-final-project`    | Enable generation of projection-type final path steps (e.g., the `.foo` in `variable.foo`)                                                |                 N                  |            N             |                  Y                  |             Y             |             |
